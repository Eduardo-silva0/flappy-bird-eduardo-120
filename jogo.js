    ...
    const canos = {
        ...
        desenha() {
            canos.pares.forEach(function(par) {
                const yRandom = par.y;
                const espasamentoEntreCanos = 120;
                ...
                const canoChaoY = canos.altura + espasamentoEntreCanos + yRandom;
                contexto.drawImage(
                    sprites,
        ...
        atualiza() {
            ...
            canos.pares.forEach(function(par) {
                ...
                if(canos.temColisaoComOFlappyBrid(par)) {
                    console.log('vocer perdue')
                    mudaParaTela(Telas.INICIO)
                }
